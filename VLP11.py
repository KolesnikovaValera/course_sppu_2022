...
df = pd \
    .read_json(
    'https://raw.githubusercontent.com/AlexeyVodopyan/course_sppu_2022/main/homeworks/homework_1/input_data/11.json',
...
print(result)
with open('C:/Users/79996/Desktop/Документы/output.json', 'w') as outfile:
